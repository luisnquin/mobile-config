{
  ...
  prepareToolchain = name: sourcePackage:
    runCommand name {
      nativeBuildInputs = [
        file
        findutils
  ...
  candidateKernel =
    runCommand "huawei-marie-kernel-candidate-4.14.116" {
      nativeBuildInputs = [
        bc
        bison
        clang
    ...
    '';
  resolvedConfig =
    runCommand "huawei-marie-kernel-config" {
      nativeBuildInputs = [
        bc
        bison
        clang
...
in {
  ...
  huawei-marie-kernel-toolchain-audit =
    runCommand "huawei-marie-kernel-toolchain-audit" {
  ...
  huawei-marie-kernel-source-audit =
    runCommand "huawei-marie-kernel-source-audit.json" {
      nativeBuildInputs = [
        coreutils
        gnugrep
        gnutar
